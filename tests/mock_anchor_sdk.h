#ifndef MOCK_ANCHOR_SDK_H
#define MOCK_ANCHOR_SDK_H
...
typedef struct {uint8_t deviceRole,deviceType,multiNodeMode,macAddrMode,deviceMacAddr[8],scheduledMode,rangingRoundUsage;} phRangingParams_t;
...
tUWBAPI_STATUS UwbApi_SessionInit(uint32_t,unsigned,uint32_t *);
